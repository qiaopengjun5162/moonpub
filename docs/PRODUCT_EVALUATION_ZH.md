...
如果你现在更需要的是“MoonPub 到底应该怎样被当成一个产品来理解”，先看 [PRODUCT_WRAP_ZH.md](PRODUCT_WRAP_ZH.md)。那份文档会先把 Core、输入工作流层和用户入口层拆开，再回来读这份评估会更顺。
...
1. **补真实首次体验证据**
   先把插件首页、飞书和照片三条路径的截图、录屏、walkthrough 做实。

2. **把插件首页继续收成正式首页**
   现在已经形成雏形，接下来要继续压缩“第一次点哪里”的成本。

3. **继续统一入口文档口径**
   尤其是英文 README、产品包装和执行计划，不要再落回旧阶段。

4. **定义输入源抽象的方向**
   让飞书、照片、语音不再只是零散功能点。

5. **继续写 Agent / 本地 App 集成文档**
   不急着做完整产品，但先把接口边界说清楚。
